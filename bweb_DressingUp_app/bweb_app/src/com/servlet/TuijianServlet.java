...
import com.bean.Tuijian;
import com.ideabobo.db.DBTool;
import com.ideabobo.db.Page;
import com.ideabobo.util.IdeaServlet;

public class TuijianServlet extends IdeaServlet {
	private DBTool dbTool = new DBTool(null, Tuijian.class);
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(action == null){
			...
			Tuijian model = (Tuijian) getByRequest(Tuijian.class,false);
			try {
				dbTool.insert(model);
				render("success");
			} catch (Exception e) {
