        ...
        switch (view.getId()) {
            ...
            case R.id.update_password_btn:
                ...
                if(TextUtils.isEmpty(password) || TextUtils.isEmpty(password2) || TextUtils.isEmpty(originalPassword)){
                    T.showToast(this_,getString(R.string.please_input_complete_str));
                    return;
                }else{
                    if(!password.equals(password2)){
                        ...
                        if(!originalPassword.equals(ManagerComm.loginUser.getPasswd())){
                            T.showToast(this_,getString(R.string.yuan_pass_error_str));
                        }else{
                            ...
                            HttpUtil.post("ClientServlet", params, new TextHttpResponseHandler() {
                                ...
                                public void onSuccess(int i, Header[] headers, String s) {
                                    if(isFail(s)){
                                        T.showToast(this_,getString(R.string.update_pass_error_str));
                                    }else{
                                        T.showToast(this_,getString(R.string.update_error_success_str));
                                        finish();
                                    }
                                }
                            });
