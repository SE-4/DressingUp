        ...
        switch (view.getId()) {
            ...
            case R.id.find_btn:
                ...
                if(TextUtils.isEmpty(username) || TextUtils.isEmpty(email)){
                    T.showToast(this_,getString(R.string.please_input_username_or_email_str));
                }else{
                    ...
                    HttpUtil.post("ClientServlet", params, new TextHttpResponseHandler() {
                        ...
                        public void onSuccess(int i, Header[] headers, String s) {
                            if(isFail(s)){
                                T.showToast(this_,getString(R.string.find_pass_error_str));
                            }else {
                                T.showToast(this_,getString(R.string.email_sended_str));
                            }
                        }
                    });
                }
