...
public class DianzanActivity$$ViewBinder<T extends com.example.androidtemplate.DianzanActivity> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131361832, "field 'searchSv'");
    target.searchSv = finder.castView(view, 2131361832, "field 'searchSv'");
