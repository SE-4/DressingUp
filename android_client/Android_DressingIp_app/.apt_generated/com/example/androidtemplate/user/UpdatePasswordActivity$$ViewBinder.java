...
public class UpdatePasswordActivity$$ViewBinder<T extends com.example.androidtemplate.user.UpdatePasswordActivity> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131361824, "field 'originalPasswordEt'");
    target.originalPasswordEt = finder.castView(view, 2131361824, "field 'originalPasswordEt'");
    view = finder.findRequiredView(source, 2131361825, "field 'updatePasswordBtn' and method 'onClick'");
    target.updatePasswordBtn = finder.castView(view, 2131361825, "field 'updatePasswordBtn'");
    view.setOnClickListener(
      new butterknife.internal.DebouncingOnClickListener() {
        @Override public void doClick(
          android.view.View p0
