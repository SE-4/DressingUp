...
public class PersonalActivity$$ViewBinder<T extends com.example.androidtemplate.user.PersonalActivity> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131361811, "field 'exitTv' and method 'onClick'");
    target.exitTv = finder.castView(view, 2131361811, "field 'exitTv'");
    ...
    view = finder.findRequiredView(source, 2131361808, "field 'userUpdateTv' and method 'onClick'");
    target.userUpdateTv = finder.castView(view, 2131361808, "field 'userUpdateTv'");
    view.setOnClickListener(
      new butterknife.internal.DebouncingOnClickListener() {
        @Override public void doClick(
          android.view.View p0
    ...
    view = finder.findRequiredView(source, 2131361809, "field 'updatePasswordTv' and method 'onClick'");
    target.updatePasswordTv = finder.castView(view, 2131361809, "field 'updatePasswordTv'");
    view.setOnClickListener(
      new butterknife.internal.DebouncingOnClickListener() {
        @Override public void doClick(
          android.view.View p0
    ...
    view = finder.findRequiredView(source, 2131361810, "field 'logoutTv' and method 'onClick'");
    target.logoutTv = finder.castView(view, 2131361810, "field 'logoutTv'");
    view.setOnClickListener(
      new butterknife.internal.DebouncingOnClickListener() {
        @Override public void doClick(
          android.view.View p0
