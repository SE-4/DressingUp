...
public class LoginActivity$$ViewBinder<T extends com.example.androidtemplate.user.LoginActivity> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131361803, "field 'checkBox'");
    target.checkBox = finder.castView(view, 2131361803, "field 'checkBox'");
    ...
    view = finder.findRequiredView(source, 2131361804, "field 'autoLoginSw'");
    target.autoLoginSw = finder.castView(view, 2131361804, "field 'autoLoginSw'");
    ...
    view = finder.findRequiredView(source, 2131361805, "field 'loginBtn' and method 'onClick'");
    target.loginBtn = finder.castView(view, 2131361805, "field 'loginBtn'");
    view.setOnClickListener(
      new butterknife.internal.DebouncingOnClickListener() {
        @Override public void doClick(
          android.view.View p0
    ...
    view = finder.findRequiredView(source, 2131361806, "field 'forgetPassTv' and method 'onClick'");
    target.forgetPassTv = finder.castView(view, 2131361806, "field 'forgetPassTv'");
    view.setOnClickListener(
      new butterknife.internal.DebouncingOnClickListener() {
        @Override public void doClick(
          android.view.View p0
    ...
    view = finder.findRequiredView(source, 2131361807, "field 'switchFunTv' and method 'onClick'");
    target.switchFunTv = finder.castView(view, 2131361807, "field 'switchFunTv'");
    view.setOnClickListener(
      new butterknife.internal.DebouncingOnClickListener() {
        @Override public void doClick(
          android.view.View p0
